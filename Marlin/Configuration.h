...
#define STRING_CONFIG_H_AUTHOR "(Hubert, DeltaFold II)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_RAMPS_14_RE_ARM_EFF
#endif

// Name displayed in the LCD "Ready" message and Info menu
#define CUSTOM_MACHINE_NAME "DeftaFold II"
...
// Homing speeds (mm/min) - Delta only homes to Z
