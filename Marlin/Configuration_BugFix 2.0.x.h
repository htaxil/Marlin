...
#define STRING_CONFIG_H_AUTHOR "(Hubert, DeltaFold-2.0.X root config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "DF Proto II"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //HotEnd Merlin isolee (etalonage du 2017/01/15 à 210°C)
  //  #define  DEFAULT_Kp 28.16
  //  #define  DEFAULT_Ki 2.03
  //  #define  DEFAULT_Kd 97.56

  //HotEnd Hexa noire chinoise isolee (etalonage du 2018/05/12 à 200°C 8 cycles : M303 E0 S200 C8)
...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define DELTA_CALIBRATION_RADIUS 95.0 // (mm)
  ...
  //#define DELTA_DIAGONAL_ROD 254.5 // mm Bras alu
  #define DELTA_DIAGONAL_ROD 237 // mm Bras carbone plus petits

  // Distance between bed and nozzle Z home position
  #define DELTA_HEIGHT 289.6             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 116.47              // (mm) Get this value from G33 auto calibrate
...
#define DEFAULT_XYZ_STEPS_PER_UNIT XY_STEPS
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define MESH_INSET 5             // Set Mesh bounds as an inset region of the bed (offset interne)
