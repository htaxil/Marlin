...
/**
 * RAMPS LCD adapter on re-arm 
 * - https://reprap.org/wiki/File:Re-ARM_LCD_adapter.jpg
 * - https://reprap.org/wiki/File:Re-ARM_LCD_adapter_MKS_Rev_4.jpg
 *                _____                                            _____
 * (BEEPER) 1.30 | · · | 2.11 (BTN_ENC)          (MISO)      0.17 | · · | 0.15 (SD_SCK)
 * (LCD_EN) 0.18 | · · | 0.16 (LCD_RS)           (BTN_EN1)   3.26 | · · | 1.23 (SD_CS2)
 * (LCD_D4) 0.15 | · · | NC   (LCD_D5)           (BTN_EN2)   3.25 | · · | 0.18 (SD_MOSI)
 * (LCD_D6)  NC  | · · | NC   (LCD_D7)           (SD_DETECT) 1.31 | · · | 1.22 (RST)
 *           GND | · · | 3.3V                                 GND | · · | NC
 *                -----                                            -----
 *                EXP1 (J3)                                             EXP2 (J5)
 */
